...
/*
Given a string 'str' of size ‘n’. The task is to insert the minimum number of characters
...
this questions is same as deletion of minmumnumber of charcater to form palindrome
